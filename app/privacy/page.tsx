  ...
  return (
    <>
      ...
      <div className="legal-content">
        ...
        <p><strong>Ambroise Partners</strong><br />Registered in Paris, France<br />Contact: <a href="mailto:contact@ambroise-partners.com" style={{ color: 'var(--blue)' }}>contact@ambroise-partners.com</a></p>
        ...
        <p>To exercise any of these rights, please contact us at <a href="mailto:contact@ambroise-partners.com" style={{ color: 'var(--blue)' }}>contact@ambroise-partners.com</a>.</p>
