  ...
  return (
    <>
      ...
      <div className="legal-content">
        ...
        <p><strong>Ambroise Partners</strong><br />Registered in Paris, France<br />Contact details available upon request.</p>
        ...
        <p>To exercise any of these rights, please reach out to us through your usual Ambroise Partners representative.</p>
