        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
        ...
        #hero-fade{
          ...
          background:linear-gradient(to top,
            ...
            #050e42 53%,
            #162d50 58%,
            rgba(22,45,80,0.85) 62%,
            rgba(22,45,80,0.7) 65%,
            rgba(22,45,80,0.55) 68%,
            rgba(22,45,80,0.4) 71%,
            rgba(22,45,80,0.28) 74%,
            rgba(22,45,80,0.16) 77%,
            rgba(22,45,80,0.08) 80%,
            rgba(22,45,80,0.03) 84%,
            transparent 88%
          );
          opacity:0;
        ...
        .btn-dark:hover{background:#162d50;transform:translateY(-2px);box-shadow:0 10px 26px rgba(22,45,80,.2);}
        ...
        .about-dark::before{content:'';position:absolute;top:-60px;right:-60px;width:240px;height:240px;background:radial-gradient(circle,rgba(22,45,80,.22) 0%,transparent 70%);border-radius:50%;}
        ...
        .fi:focus,.ft:focus{border-color:var(--blue);box-shadow:0 0 0 3px rgba(22,45,80,.1);}
        ...
        .submit-btn:hover{background:#162d50;border-color:#162d50;transform:translateY(-2px);box-shadow:0 10px 28px rgba(22,45,80,.2);}
        ...
        /* ── FOOTER ── */
        footer{background:#162d50;color:#fff;padding:3rem 2.5vw 2rem;}
