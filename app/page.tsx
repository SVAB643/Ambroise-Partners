 ...
 * { box-sizing: border-box; margin: 0; padding: 0; }
 ...
 section { padding: 4.5rem 6vw; max-width: 1400px; margin: 0 auto; }
        ...
        #services .title {
          ...
          font-style: italic;
          font-weight: 700;
          font-size: clamp(3.1rem, 4.4vw, 3.8rem);
 ...
 padding: 18rem 6vw 4rem;
        ...
        .footer { padding: 4rem 6vw 3rem; background: #0a0f2c; }
        .footer-simple {
          display: flex;
 ...
 /* Fade-in */
        ...
        .fade-in:nth-of-type(odd), .fade-in-section:nth-of-type(odd) { transition-duration: 0.78s; }
        .fade-in:nth-of-type(even), .fade-in-section:nth-of-type(even) { transition-duration: 0.58s; }
 ...
 .services-grid .card { border: none; }
        ...
        @media (max-width: 640px) {
          ...
          .hero-line + .hero-line { margin-top: 0.35rem; }
          .hero-line--top { font-size: clamp(2.2rem, 5.8vw, 2.9rem); letter-spacing: 0.2em; }
          .hero-line--mid { font-size: clamp(1.6rem, 4.6vw, 2.1rem); }
          .hero-line--bottom { font-size: clamp(2.8rem, 6.4vw, 3.6rem); letter-spacing: 0.08em; }
 ...
 <a className="btn" href="#contact"><span>Contact us</span></a>
      ...
      <header className="hero">
        <div className="hero-card fade-in visible">
          ...
          <div className="hero-tags" style={{ marginTop: '1.4rem' }}>
            <span>M&A</span>
 ...
 <button type="submit" className="btn btn-primary">Send</button>
      ...
      <footer className="footer" style={{ background: '#0a0f2c' }}>
